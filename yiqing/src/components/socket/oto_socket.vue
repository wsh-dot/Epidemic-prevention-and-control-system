      ...
      <el-col :span="24" style="">
        <el-card class="group">
          <div class="group_head">
            <el-page-header class="title" @back="goBack" content="单人聊天">
...
// }
// .box .group .group_head .title {
//   height: 4rem;
//   display: flex;
//   justify-content: flex-start;
//   align-items: center;
// }
// .box .group .group_head .title span {
//   font-family: "Helvetica Neue", Arial, sans-serif;
//   font-size: 1.8rem;
// }
// .box .group .group_head .group_head_online {
//   position: absolute;
//   right: 1.5rem;
//   top: -1rem;
//   color: dodgerblue;
